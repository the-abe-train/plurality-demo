export default function whatIsPlurality() {
  return (
    <section className="my-4 space-y-2">
      ...
      <ul className="list-disc list-inside">
        <li>
          Plurality is a <b>game</b> that tests how well you know the thoughts,
          feelings, and opinions of the people around you.{" "}
        </li>
        <li>
          Plurality is a <b>platform</b> for sharing your own ideas with the
          rest of the world.{" "}
        </li>
        <li>
      ...
      <p>
        Read the instructions to get started, or connect your Crypto wallet and
        dive right in!
      </p>
    </section>
  );
